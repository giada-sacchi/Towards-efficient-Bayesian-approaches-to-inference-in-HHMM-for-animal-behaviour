...
source("updatepar.R") ## Load packages and function for parameter updates
source("mllk.R") ## Load minus loglikelihood function
...
# Save in external files
saveRDS(est, "est_MH_tot.rds")
saveRDS(itns, "itns_MH_tot.rds")
save.image("global_MH.RData")
